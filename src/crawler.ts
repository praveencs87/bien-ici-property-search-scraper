...
import { ScraperInput, CONFIG, SELECTORS } from './config.js';
import { handleDetailPage } from './handlers/detailHandler.js';

export async function createCrawler(input: ScraperInput) {
    ...
    return new PlaywrightCrawler({
        proxyConfiguration: await Actor.createProxyConfiguration(
            input.proxyConfiguration || { useApifyProxy: true, apifyProxyCountry: 'FR' }
        ),
        ...
        failedRequestHandler: async ({ request, log }: any, error: any) => {
